                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $bookingHariIni ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Pasien
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalPasien ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Stok Obat Menipis</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach($stokMenipis as $barang)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    {{ $barang->nama_barang }}
                                    <span class="badge badge-danger badge-pill">{{ $barang->stok }}</span>
                                </li>
                            @endforeach
                        </ul>
                    @else
                        <p class="text-center text-success mt-3">Stok aman.</p>
                    @endif
                </div>
            </div>
        </div>
