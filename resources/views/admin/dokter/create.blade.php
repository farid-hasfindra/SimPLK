        ...
        <div class="card-body">
            <form action="{{ route('admin.dokter.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_sip') is-invalid @enderror" id="no_sip" name="no_sip" value="{{ old('no_sip') }}" required>
                    @error('no_sip')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control @error('tarif_dasar') is-invalid @enderror" id="tarif_dasar" name="tarif_dasar" value="{{ old('tarif_dasar') }}" min="0" required>
                    @error('tarif_dasar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
